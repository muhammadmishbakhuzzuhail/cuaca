   ...
   return (
      <>
         <div className="grid grid-cols-3 grid-rows-3 gap-4">
            ...
            {isLoading &&
               Array.from({ length: 9 }, (_, id) => <LoadingPreviewCardCuaca key={id} />)}
            ...
            {isError && (
               <div className="col-span-3 row-span-3 flex items-center justify-center bg-red-50 rounded-md border border-red-200 py-96">
                  <div className="text-center">
                     ...
                     <p className="text-red-400">Gagal memuat data. Silakan coba lagi nanti.</p>
                  </div>
               </div>
            )}
         </div>
            ...
            <PaginationContent>
               ...
               {page > totalPage - 4 && (
                  <>
                     ...
                     {[totalPage - 4, totalPage - 3, totalPage - 2, totalPage - 1].map((item) => (
                        <PaginationItem key={item}>
                           <PaginationLink
                              href="#"
                              isActive={page === item}
